...
class createACLTable extends Migration
{
    ...
    public function down()
    {
        ...
        $this->schema->dropIfExists($tableNames['role_has_permissions']);
        $this->schema->dropIfExists($tableNames['model_has_roles']);
        $this->schema->dropIfExists($tableNames['model_has_permissions']);
        $this->schema->dropIfExists($tableNames['roles']);
        $this->schema->dropIfExists($tableNames['permissions']);
    }
}
